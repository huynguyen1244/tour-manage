...
export default function Footer() {
  ...
  const handleSubscribe = (e) => {
    ...
    if (email && email.includes("@")) {
      // In a real app, this would call an API to add the email to a newsletter list
      setSubscribed(true);
      setEmail("");
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">TourExplorer</span>
            </div>
            <p className="text-gray-300 mb-4">
              Discover the world's most amazing places with our expertly curated
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Get exclusive offers and travel inspiration directly to your
              inbox.
            </p>

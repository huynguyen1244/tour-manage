...
import { CreditCard, User as UserIcon, Calendar, Phone, Mail, ChevronsUpDown, Users } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-2xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center text-muted-foreground text-sm mb-3">
            ...
            <span>{bookingData.numberOfTravelers} {bookingData.numberOfTravelers === 1 ? 'Adult' : 'Adults'}</span>
          </div>
            ...
            <div className="relative">
              ...
              <div className="absolute right-3 top-2 flex space-x-1">
                <svg className="h-6 w-auto" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M45 35C45 37.2 43.2 39 41 39H7C4.8 39 3 37.2 3 35V13C3 10.8 4.8 9 7 9H41C43.2 9 45 10.8 45 13V35Z" fill="#1565C0"/>
                  <path d="M15.5 23L20.5 16.5H17L13.5 21.5L10 16.5H6.5L10 23L6 30H9.5L13.5 24.5L17.5 30H21L15.5 23Z" fill="white"/>
                ...
                <svg className="h-6 w-auto" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M18,24c0,4.755,2.376,8.95,6,11.48c3.624-2.53,6-6.725,6-11.48s-2.376-8.95-6-11.48 C20.376,15.05,18,19.245,18,24z" fill="#FF3D00"/>
                </svg>
                <svg className="h-6 w-auto" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M45 35C45 37.2 43.2 39 41 39H7C4.8 39 3 37.2 3 35V13C3 10.8 4.8 9 7 9H41C43.2 9 45 10.8 45 13V35Z" fill="#1565C0"/>
                  <path d="M22.255 20L20.142 24.683L18.039 20H15.344V26.726L12.341 20H10.067L7 26.981H8.815L9.516 25.387H13.276L13.977 26.981H17.458V21.594L19.803 26.981H21.445L23.79 21.644V26.981H25.6V20H22.255Z" fill="white"/>
                  <path d="M10.699 23.775L11.879 21.094L13.059 23.775H10.699Z" fill="white"/>
                  <path d="M37 28C38.1 28 39 27.1 39 26V22C39 20.9 38.1 20 37 20H28C26.9 20 26 20.9 26 22V26C26 27.1 26.9 28 28 28H37Z" fill="#FFC107"/>
                </svg>
              </div>
            </div>
          </div>
